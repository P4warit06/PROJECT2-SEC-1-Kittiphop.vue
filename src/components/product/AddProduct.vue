...
<template>
<div class="p-10 bg-white rounded-3xl shadow-2xl max-w-4xl mx-auto">
  <h1 class="text-4xl font-extrabold text-gray-900 mb-10 text-center">Add New Product</h1>
  ...
  <div class="grid grid-cols-2 gap-8">
    ...
    <div class="col-span-2 flex gap-8 justify-center mt-8">
      <button @click="$emit('addNewProduct', newProduct)" 
        class="w-1/3 bg-indigo-500 text-white py-3 rounded-xl hover:bg-indigo-600">Add Product</button>
